...
/**
 * Translates AND criteria for solr
 * 
 * @package Extlist
 * @subpackage DataBackend\QueryInterpreter
 * @author Daniel Lienert
 * @author Michael Knoll
 */
class Tx_PtSolr_Extlist_DataBackend_QueryInterpreter_AndCriteriaTranslator implements Tx_PtSolr_Extlist_DataBackend_QueryInterpreter_TranslatorInterface {
	...
	/**
     * Returns translated criteria string for AND criteria
     *
